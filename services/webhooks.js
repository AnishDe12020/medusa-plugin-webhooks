...
var WebhooksService = /*#__PURE__*/function (_NotificationService) {
  _inherits(WebhooksService, _NotificationService);
  ...
  _createClass(WebhooksService, [{
    ...
    value: function () {
      var _handleOrderEvents = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(id) {
        var order;
    ...
    key: "fetchData",
    value: function () {
      var _fetchData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(event, eventData) {
    ...
    value: function () {
      var _sendNotification = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(event, eventData) {
        var _this$options_$webhoo, _this$options_$webhoo2;
            ...
            switch (_context3.prev = _context3.next) {
              ...
              case 4:
                ...
                return this.postWebhook({
                  event: event,
                  data: data
                }, (_this$options_$webhoo = this.options_.webhook_config[event].overrideUrl) !== null && _this$options_$webhoo !== void 0 ? _this$options_$webhoo : null, (_this$options_$webhoo2 = this.options_.webhook_config[event].overrideHeaders) !== null && _this$options_$webhoo2 !== void 0 ? _this$options_$webhoo2 : null);
    ...
    key: "postWebhook",
    value: function () {
      var _postWebhook = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(data, overrideUrl, overrideHeaders) {
...
_defineProperty(WebhooksService, "identifier", "webhooks");
